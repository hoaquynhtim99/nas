...
// Thiết lập giao diện phân trang
$theme_config = [
    'pagination' => [
...
function nv_site_theme($contents, $full = true)
{
    ...
    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/css/boxicons.min.css'
    ];
    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => ASSETS_STATIC_URL . '/js/perfect-scrollbar/style.css'
    ];
    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/css/nv.style.css'
    ];
    ...
    $html_js[] = [
        'ext' => 1,
        'content' => ASSETS_STATIC_URL . '/js/perfect-scrollbar/min.js'
    ];
    $html_js[] = [
        'ext' => 1,
        'content' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/js/long-press-event.min.js'
    ];
    $html_js[] = [
        'ext' => 1,
        'content' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/js/jquery.touchSwipe.min.js'
    ];
    $html_js[] = [
        'ext' => 1,
        'content' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/js/nv.core.js'
    ];
